...
[conversation and execution](components/transcript-v1.html), with the existing native color scheme.
...
[Actions menu](components/actions-v1.html). Approved versions stay fixed unless
