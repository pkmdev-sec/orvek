...
[file picker](components/files-v1.html), [skill picker](components/skills-v1.html), and
[message queue](components/queue-v1.html),
...
[child-agent view](components/agents-v1.html). Approved versions stay fixed unless
