...
[conversation and execution](components/transcript-v1.html), and [Actions](components/actions-v1.html),
...
[persistent activity indicator](components/activity-v1.html). Approved versions stay fixed unless
