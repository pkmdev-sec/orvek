...
and [activity indicator](components/activity-v1.html), with the existing native color scheme.
...
[model selector](components/model-v1.html). Approved versions stay fixed unless
