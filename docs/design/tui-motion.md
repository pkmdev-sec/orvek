...
[activity indicator](components/activity-v1.html), and [model selector](components/model-v1.html),
...
[effort selector](components/effort-v1.html). Approved versions stay fixed unless
